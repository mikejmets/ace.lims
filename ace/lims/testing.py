...
class ACETestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        self.loadZCML(package=ace.lims)

        # Required by Products.CMFPlone:plone-content
        z2.installProduct(app, 'Products.PythonScripts')
        z2.installProduct(app, 'ace.lims')
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'ace.lims:default')
        ...
        self.request.form['existing'] = "ace.lims:test"
        lsd = LoadSetupData(portal, self.request)
        lsd()

        logout()

CUSTOM_TEST_FIXTURE = ACETestLayer()

ACE_CUSTOM_TESTING = FunctionalTesting(
